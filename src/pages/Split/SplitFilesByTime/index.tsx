...
import "./styles.css";
import { Modal, Button, Row, Progress, Radio, InputNumber } from "antd";
...
export default class SplitFilesByTime extends React.Component<
  PropsType,
  StateType
> {
          ...
          <Row>
            <InputNumber
              ...
              onChange={(value: number | null) => {
                this.setState({
                  duration: typeof value === "number" ? value : 3,
                });
              }}
            />
          </Row>
